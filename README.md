...
**Instrucciones:**
  ...
  3- Descomprimir el archivo "Grupo16-INF225-Hito-5"
  
  4- Llevar **los archivos descomprimidos de "proyecto2025-hito5.zip"** a htdocs en Xampp (se recomienda borrar los archivos presentes en htdocs, a menos que sea un proyecto en carpeta) (se deja el código del avance anterior 'proyecto.zip' en caso de necesitarlo)
  ...
  7- Abrir "http://localhost/proyecto2025-hito5/proyecto/init.html" con google u otro navegador
...
- **Creación en Windows**
- **Guarde en htdocs de la forma: proyecto2025-hito5/proyecto/...**
